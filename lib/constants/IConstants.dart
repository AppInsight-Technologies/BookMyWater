...
class IConstants {
  static String BaseDomain =
      "https://login.bookmywater.in";/*"https://saas.grocbay.com";*//*"https://sandbox.grocbay.com";*/
  ...
  static String APP_NAME = "bookMyWater";
  ...
  static String refIdForMultiVendor = /*"1106"*/"1132";
